...
def handle_sound_command(message, message_object, thread_id, thread_type, author_id, client):
    ...
    try:
        api_url = f'http://www.hungdev.id.vn/medias/down-aio?apiKey=cb81672f5843ae076a6d7e2dafeba9&url={linksound}'
        # curl 'https://hungdev.id.vn/medias/down-aio?url=https%3A%2F%2Fexample.com%2Ffile.png'
