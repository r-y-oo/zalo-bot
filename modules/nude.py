...
des = {
    ...
    'description': "𝕏𝕖𝕞 𝕒̉𝕟𝕙 𝕟𝕦̛̃ 𝕕𝕖̂"
}


def handle_anhnude_command(message, message_object, thread_id, thread_type, author_id, client):
    ...
    try:
        ...
        api_url = 'https://api.nemg.me/images/nude'
