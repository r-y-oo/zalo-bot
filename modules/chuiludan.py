...
des = {
    ...
    'description': "chửi chết mẹ lũ đần"
}
...
def handle_war_command(message, message_object, thread_id, thread_type, author_id, client):
    ...
    if len(command_parts) < 2:
        client.replyMessage(Message(text="Vui lòng chỉ định lệnh hợp lệ (vd: chuiludan on hoặc stop)."), message_object, thread_id, thread_type)
        return
