...
def handle_info(message, message_object, thread_id, thread_type, author_id, bot):
    ...
    try:
        ...
        bot.replyMessage(message,message_object, thread_id=thread_id, thread_type=thread_type,ttl=60000)
        

    except Exception as e:
        print(f"Error: {e}")
        bot.replyMessage(Message(text=msg_error),message_object, thread_id, thread_type,ttl=60000)
